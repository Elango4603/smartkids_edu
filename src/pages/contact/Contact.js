...
const Contact = () => {
  ...
  return (
        ...
        <div class="max-w-6xl mx-8 xl:mx-auto bg-[#e07330] hover:bg-green-700 rounded-lg">
                    <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                        <div>
                            ...
                            <ul class="flex mt-12 space-x-4">
                                <li class="bg-[#1c216f] hover:bg-[#e07330] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                ...
                                <li class="bg-[#263c66] hover:bg-[#e07330] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <a href="javascript:void(0)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                            viewBox="0 0 511 512">
                                            <path
                                ...
                                <li class="bg-[#671c74] hover:bg-[#e07330] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                    <a href="javascript:void(0)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='#fff'
                                            viewBox="0 0 24 24">
                                            <path
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg">
                            ...
                            <div class="space-y-4 max-lg:mt-4">
                                <button type="button" class="px-4 py-2 rounded-lg bg-[#2f663c] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#2f663c] mr-4">Young Readers</button>
                                <button type="button" class="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4"> Kids Zone</button>
                                <button type="button" class="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300"> Math Mystery</button>
                            </div>

                            <form class="mt-8 space-y-4">
                                <input type='text' placeholder='Name'
                                    class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#2f663c]" />
                                <input type='email' placeholder='Email'
                                    class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#2f663c]" />
                                <input type='text' placeholder='Subject'
                                    class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#2f663c]" />
                                <textarea placeholder='Message' rows="6"
                                    class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#2f663c]"></textarea>
                                <button type='button'
                                    class="text-white bg-[#2f663c] hover:bg-[#2f663ce2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
